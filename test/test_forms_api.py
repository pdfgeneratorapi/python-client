...
class TestFormsApi(unittest.TestCase):
    ...
    def test_open_form_builder(self) -> None:
        """Test case for open_form_builder

        Open new form builder
        """
        pass

    def test_open_form_builder_for_existing_form(self) -> None:
        """Test case for open_form_builder_for_existing_form

        Open existing form builder
        """
        pass

    def test_share_form(self) -> None:
        """Test case for share_form
