...
class TestCreateTemplate201Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateTemplate201Response:
        """Test CreateTemplate201Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateTemplate201Response`
        """
        model = CreateTemplate201Response()
        if include_optional:
            return CreateTemplate201Response(
                response = pdf_generator_api_client.models.template_definition.TemplateDefinition(
                    ...
                    layout = pdf_generator_api_client.models.template_definition_new_layout.TemplateDefinitionNew_layout(
                        ...
                        empty_labels = 0, ), 
                    pages = [
                        pdf_generator_api_client.models.template_definition_pages_inner.TemplateDefinition_pages_inner(
                            width = 21, 
                            height = 29.7, 
                            components = [
                                None
    ...
    def testCreateTemplate201Response(self):
        """Test CreateTemplate201Response"""
