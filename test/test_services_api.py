...
class TestServicesApi(unittest.TestCase):
    ...
    def test_add_watermark(self) -> None:
        """Test case for add_watermark

        Add watermark
        """
        pass

    def test_decrypt_document(self) -> None:
        """Test case for decrypt_document

        Decrypt document
        """
        pass

    def test_encrypt_document(self) -> None:
        """Test case for encrypt_document
    ...
    def test_extract_form_fields(self) -> None:
        """Test case for extract_form_fields

        Extract form fields
        """
        pass

    def test_fill_form_fields(self) -> None:
        """Test case for fill_form_fields

        Fill form fields
        """
        pass

    def test_make_accessible(self) -> None:
        """Test case for make_accessible

        Make accessible
        """
        pass

    def test_optimize_document(self) -> None:
        """Test case for optimize_document
