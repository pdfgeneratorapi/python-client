...
class TestWatermarkBase64(unittest.TestCase):
    """WatermarkBase64 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WatermarkBase64:
        """Test WatermarkBase64
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WatermarkBase64`
        """
        model = WatermarkBase64()
        if include_optional:
