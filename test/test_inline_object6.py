    ...
    def make_instance(self, include_optional) -> InlineObject6:
        ...
        if include_optional:
            return InlineObject6(
                response = [
                    pdf_generator_api_client.models.form_configuration.FormConfiguration(
                        id = 1, 
                        template_id = 123123, 
                        ...
                        fields = [
                            pdf_generator_api_client.models.form_fields_inner.formFields_inner(
                                label = 'Full name', 
                                name = 'name', 
                                type = 'text', 
                                required = False, )
                            ], 
                        configuration = pdf_generator_api_client.models.form_configuration.formConfiguration(
                            title = 'Employment application', 
                            intro = 'Please fill in all required fields.', 
                            outro = 'Thank you for your submission.', ), )
                    ],
                meta = pdf_generator_api_client.models.pagination_meta.paginationMeta(
                    current_page = 1, 
                    last_page = 1, 
                    per_page = 15, )
            )
