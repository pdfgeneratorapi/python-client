...
class TestTemplateDefinitionNew(unittest.TestCase):
    """TemplateDefinitionNew unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TemplateDefinitionNew:
        """Test TemplateDefinitionNew
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TemplateDefinitionNew`
        """
        model = TemplateDefinitionNew()
        if include_optional:
            return TemplateDefinitionNew(
                ...
                layout = pdf_generator_api_client.models.template_definition_new_layout.TemplateDefinitionNew_layout(
                    ...
                    empty_labels = 0, ),
                pages = [
                    pdf_generator_api_client.models.template_definition_new_pages_inner.TemplateDefinitionNew_pages_inner(
                        width = 21, 
                        height = 29.7, 
                        margins = pdf_generator_api_client.models.template_definition_new_pages_inner_margins.TemplateDefinitionNew_pages_inner_margins(
                            right = 0.5, 
                            bottom = 0.5, ), 
                        border = False, 
                        components = [], 
                        layout = pdf_generator_api_client.models.layout.layout(), 
                        conditional_formats = [], 
                        background_image = '', )
                    ],
                data_settings = pdf_generator_api_client.models.template_definition_new_data_settings.TemplateDefinitionNew_dataSettings(
                    sort_by = [], 
                    filter_by = [], 
                    transform = [], ),
                editor = pdf_generator_api_client.models.template_definition_new_editor.TemplateDefinitionNew_editor(
                    height_multiplier = 1, ),
    ...
    def testTemplateDefinitionNew(self):
        """Test TemplateDefinitionNew"""
