...
class TestCreateTemplate200Response(unittest.TestCase):
    """CreateTemplate200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateTemplate200Response:
        """Test CreateTemplate200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateTemplate200Response`
        """
        model = CreateTemplate200Response()
        if include_optional:
            return CreateTemplate200Response(
                response = pdf_generator_api_client.models.template_definition.TemplateDefinition(
                    id = 24382, 
    ...
    def testCreateTemplate200Response(self):
        """Test CreateTemplate200Response"""
