...
class TestAddWatermarkRequest(unittest.TestCase):
    """AddWatermarkRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddWatermarkRequest:
        """Test AddWatermarkRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddWatermarkRequest`
        """
        model = AddWatermarkRequest()
        if include_optional:
            return AddWatermarkRequest(
                file_url = '',
                watermark = pdf_generator_api_client.models.watermark_file_url_watermark.WatermarkFileUrl_watermark(
                    image = null, 
                    text = pdf_generator_api_client.models.watermark_text.watermarkText(
                        content = '', 
                        color = '#000000', 
                        size = 7, 
                        opacity = 0.1, 
    ...
    def testAddWatermarkRequest(self):
        """Test AddWatermarkRequest"""
