...
class WorkspacesApi:
    ...
    def create_workspace(
        self,
        create_workspace_request: Optional[CreateWorkspaceRequest] = None,
    ...
    def delete_workspace(
        self,
        workspace_identifier: Annotated[StrictStr, Field(description="Workspace identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param workspace_identifier: Workspace identifier (required)
        :type workspace_identifier: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _delete_workspace_serialize(
        ...
        if workspace_identifier is not None:
            _path_params['workspaceIdentifier'] = workspace_identifier
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/workspaces/{workspaceIdentifier}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
