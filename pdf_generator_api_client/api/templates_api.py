...
class TemplatesApi:
    ...
    def _copy_template_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/templates/{templateId}/copy',
    ...
    def create_template(
        ...
        _param = self._create_template_serialize(
            template_definition_new=template_definition_new,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _create_template_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if template_definition_new is not None:
            _body_params = template_definition_new
    ...
    def _get_template_schema_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/templates/schema',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def import_template(
        self,
        import_template_request: Annotated[ImportTemplateRequest, Field(description="Import a PDF via URL or base64 string as template")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param import_template_request: Import a PDF via URL or base64 string as template (required)
        :type import_template_request: ImportTemplateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._import_template_serialize(
    ...
    @validate_call
    def import_template_with_http_info(
        self,
        import_template_request: Annotated[ImportTemplateRequest, Field(description="Import a PDF via URL or base64 string as template")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def import_template_without_preload_content(
        self,
        import_template_request: Annotated[ImportTemplateRequest, Field(description="Import a PDF via URL or base64 string as template")],
        _request_timeout: Union[
            None,
    ...
    def _import_template_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if import_template_request is not None:
            _body_params = import_template_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/templates/import',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def validate_template_with_http_info(
        self,
        template_definition_new: Annotated[TemplateDefinitionNew, Field(description="Template configuration")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def validate_template_without_preload_content(
        self,
        template_definition_new: Annotated[TemplateDefinitionNew, Field(description="Template configuration")],
        _request_timeout: Union[
            None,
