    ...
    def __init__(self, api_client=None):
        ...
        def __create_template(
            ...
            **kwargs
            ...
            Args:
                template_definition_new (TemplateDefinitionNew): Template configuration as JSON string
            ...
            kwargs['_host_index'] = kwargs.get('_host_index')
            kwargs['template_definition_new'] = \
                template_definition_new
            return self.call_with_http_info(**kwargs)

        self.create_template = _Endpoint(
            settings={
                'response_type': (InlineResponse2001,),
                'auth': [
                    'JSONWebTokenAuth'
        ...
        def __get_editor_url(
            ...
            **kwargs
            ...
            Returns an unique URL which you can use to redirect your user to the editor from your application or use the generated URL as iframe source to show the editor within your application. When using iframe, make sure that your browser allows third-party cookies.   # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True
        ...
        self.update_template = _Endpoint(
            settings={
                'response_type': (InlineResponse2001,),
                'auth': [
                    'JSONWebTokenAuth'
