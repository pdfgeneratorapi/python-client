...
from pdf_generator_api_client.rest import RESTResponseType
...
class DocumentsApi:
    ...
    def delete_document(
        self,
        public_id: Annotated[StrictStr, Field(description="Resource public id")],
        ...
        :param public_id: Resource public id (required)
        :type public_id: str
    ...
    def _delete_document_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/documents/{publicId}',
    ...
    def generate_document(
        self,
        generate_document_request: Annotated[GenerateDocumentRequest, Field(description="Request parameters, including template id, data and formats.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param generate_document_request: Request parameters, including template id, data and formats. (required)
        :type generate_document_request: GenerateDocumentRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._generate_document_serialize(
            generate_document_request=generate_document_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def generate_document_with_http_info(
        self,
        generate_document_request: Annotated[GenerateDocumentRequest, Field(description="Request parameters, including template id, data and formats.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def generate_document_without_preload_content(
        self,
        generate_document_request: Annotated[GenerateDocumentRequest, Field(description="Request parameters, including template id, data and formats.")],
        _request_timeout: Union[
            None,
    ...
    def _generate_document_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if generate_document_request is not None:
            _body_params = generate_document_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/documents/generate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def generate_document_asynchronous(
        self,
        generate_document_asynchronous_request: Annotated[GenerateDocumentAsynchronousRequest, Field(description="Request parameters, including template id, data and formats.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param generate_document_asynchronous_request: Request parameters, including template id, data and formats. (required)
        :type generate_document_asynchronous_request: GenerateDocumentAsynchronousRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._generate_document_asynchronous_serialize(
            generate_document_asynchronous_request=generate_document_asynchronous_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def generate_document_asynchronous_with_http_info(
        self,
        generate_document_asynchronous_request: Annotated[GenerateDocumentAsynchronousRequest, Field(description="Request parameters, including template id, data and formats.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def generate_document_asynchronous_without_preload_content(
        self,
        generate_document_asynchronous_request: Annotated[GenerateDocumentAsynchronousRequest, Field(description="Request parameters, including template id, data and formats.")],
        _request_timeout: Union[
            None,
    ...
    def _generate_document_asynchronous_serialize(
        self,
        generate_document_asynchronous_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if generate_document_asynchronous_request is not None:
            _body_params = generate_document_asynchronous_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/documents/generate/async',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def generate_document_batch(
        self,
        generate_document_batch_request: Annotated[GenerateDocumentBatchRequest, Field(description="Request parameters, including template id, data and formats.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param generate_document_batch_request: Request parameters, including template id, data and formats. (required)
        :type generate_document_batch_request: GenerateDocumentBatchRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._generate_document_batch_serialize(
            generate_document_batch_request=generate_document_batch_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def generate_document_batch_with_http_info(
        self,
        generate_document_batch_request: Annotated[GenerateDocumentBatchRequest, Field(description="Request parameters, including template id, data and formats.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def generate_document_batch_without_preload_content(
        self,
        generate_document_batch_request: Annotated[GenerateDocumentBatchRequest, Field(description="Request parameters, including template id, data and formats.")],
        _request_timeout: Union[
            None,
    ...
    def _generate_document_batch_serialize(
        self,
        generate_document_batch_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if generate_document_batch_request is not None:
            _body_params = generate_document_batch_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/documents/generate/batch',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def generate_document_batch_asynchronous(
        self,
        generate_document_batch_asynchronous_request: Annotated[GenerateDocumentBatchAsynchronousRequest, Field(description="Request parameters, including template id, data and formats.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param generate_document_batch_asynchronous_request: Request parameters, including template id, data and formats. (required)
        :type generate_document_batch_asynchronous_request: GenerateDocumentBatchAsynchronousRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._generate_document_batch_asynchronous_serialize(
            generate_document_batch_asynchronous_request=generate_document_batch_asynchronous_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def generate_document_batch_asynchronous_with_http_info(
        self,
        generate_document_batch_asynchronous_request: Annotated[GenerateDocumentBatchAsynchronousRequest, Field(description="Request parameters, including template id, data and formats.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def generate_document_batch_asynchronous_without_preload_content(
        self,
        generate_document_batch_asynchronous_request: Annotated[GenerateDocumentBatchAsynchronousRequest, Field(description="Request parameters, including template id, data and formats.")],
        _request_timeout: Union[
            None,
    ...
    def _generate_document_batch_asynchronous_serialize(
        self,
        generate_document_batch_asynchronous_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if generate_document_batch_asynchronous_request is not None:
            _body_params = generate_document_batch_asynchronous_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/documents/generate/batch/async',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def generate_viewer_url(
        self,
        public_id: Annotated[StrictStr, Field(description="Resource public id")],
        generate_viewer_url_request: Annotated[Optional[GenerateViewerUrlRequest], Field(description="Optional response format and viewer prefill data.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param public_id: Resource public id (required)
        :type public_id: str
        :param generate_viewer_url_request: Optional response format and viewer prefill data.
        :type generate_viewer_url_request: GenerateViewerUrlRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._generate_viewer_url_serialize(
            public_id=public_id,
            generate_viewer_url_request=generate_viewer_url_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GenerateViewerUrl200Response",
            '201': "InlineObject11",
            '401': "InlineObject23",
            '402': "InlineObject24",
            '403': "InlineObject25",
    ...
    @validate_call
    def generate_viewer_url_with_http_info(
        self,
        public_id: Annotated[StrictStr, Field(description="Resource public id")],
        generate_viewer_url_request: Annotated[Optional[GenerateViewerUrlRequest], Field(description="Optional response format and viewer prefill data.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GenerateViewerUrl200Response]:
        """Get document with prefill
    ...
    @validate_call
    def generate_viewer_url_without_preload_content(
        self,
        public_id: Annotated[StrictStr, Field(description="Resource public id")],
        generate_viewer_url_request: Annotated[Optional[GenerateViewerUrlRequest], Field(description="Optional response format and viewer prefill data.")] = None,
        _request_timeout: Union[
    ...
    def _generate_viewer_url_serialize(
        self,
        public_id,
        generate_viewer_url_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if generate_viewer_url_request is not None:
            _body_params = generate_viewer_url_request
    ...
    def get_async_job_status(
        ...
        _param = self._get_async_job_status_serialize(
            job_id=job_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_async_job_status_with_http_info(
        self,
        job_id: Annotated[StrictStr, Field(description="Job id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_async_job_status_without_preload_content(
        self,
        job_id: Annotated[StrictStr, Field(description="Job id")],
        _request_timeout: Union[
            None,
    ...
    def _get_async_job_status_serialize(
        self,
        job_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/documents/async/{jobId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_document_actions_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/documents/{publicId}/actions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_document_versions(
        ...
        _param = self._get_document_versions_serialize(
            public_id=public_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_document_versions_with_http_info(
        self,
        public_id: Annotated[StrictStr, Field(description="Resource public id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_document_versions_without_preload_content(
        self,
        public_id: Annotated[StrictStr, Field(description="Resource public id")],
        _request_timeout: Union[
            None,
    ...
    def _get_document_versions_serialize(
        self,
        public_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/documents/{publicId}/versions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_documents(
        self,
        template_id: Annotated[Optional[StrictInt], Field(description="Template unique identifier")] = None,
        start_date: Annotated[Optional[StrictStr], Field(description="Start date. Format: Y-m-d H:i:s")] = None,
        end_date: Annotated[Optional[StrictStr], Field(description="End date. Format: Y-m-d H:i:s. Defaults to current timestamp")] = None,
        ...
        :param start_date: Start date. Format: Y-m-d H:i:s
        :type start_date: str
        :param end_date: End date. Format: Y-m-d H:i:s. Defaults to current timestamp
        :type end_date: str
    ...
    def store_document(
        self,
        store_document_request: Annotated[StoreDocumentRequest, Field(description="Document source and optional metadata. Exactly one of `file_base64` or `file_url` is required.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param store_document_request: Document source and optional metadata. Exactly one of `file_base64` or `file_url` is required. (required)
        :type store_document_request: StoreDocumentRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._store_document_serialize(
            store_document_request=store_document_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def store_document_with_http_info(
        self,
        store_document_request: Annotated[StoreDocumentRequest, Field(description="Document source and optional metadata. Exactly one of `file_base64` or `file_url` is required.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def store_document_without_preload_content(
        self,
        store_document_request: Annotated[StoreDocumentRequest, Field(description="Document source and optional metadata. Exactly one of `file_base64` or `file_url` is required.")],
        _request_timeout: Union[
            None,
    ...
    def _store_document_serialize(
        self,
        store_document_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if store_document_request is not None:
            _body_params = store_document_request
