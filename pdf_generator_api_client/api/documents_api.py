...
class DocumentsApi:
    ...
    def merge_template(
        ...
        name: Annotated[Optional[StrictStr], Field(description="Document name, returned in the meta data.")] = None,
        format: Annotated[Optional[StrictStr], Field(description="Document format. The zip option will return a ZIP file with PDF files.")] = None,
        output: Annotated[Optional[StrictStr], Field(description="Response format. \"I\" is used to return the file inline. With the url option, the document is stored for 30 days and automatically deleted.")] = None,
        ...
        :type format: str
        :param output: Response format. \"I\" is used to return the file inline. With the url option, the document is stored for 30 days and automatically deleted.
        :type output: str
    ...
    def merge_template_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MergeTemplate200Response]:
        """Generate document
    ...
    def _merge_template_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/templates/{templateId}/output',
    ...
    def merge_templates(
        self,
        batch_data_inner: Annotated[List[BatchDataInner], Field(description="Data used to specify templates and data objects which are used to merge the template")],
        name: Annotated[Optional[StrictStr], Field(description="Document name, returned in the meta data.")] = None,
        format: Annotated[Optional[StrictStr], Field(description="Document format. The zip option will return a ZIP file with PDF files.")] = None,
        output: Annotated[Optional[StrictStr], Field(description="Response format. \"I\" is used to return the file inline. With the url option, the document is stored for 30 days and automatically deleted.")] = None,
        _request_timeout: Union[
        ...
        :param batch_data_inner: Data used to specify templates and data objects which are used to merge the template (required)
        :type batch_data_inner: List[BatchDataInner]
        :param name: Document name, returned in the meta data.
        :type name: str
        :param format: Document format. The zip option will return a ZIP file with PDF files.
        :type format: str
        ...
        _param = self._merge_templates_serialize(
            batch_data_inner=batch_data_inner,
            name=name,
            format=format,
            output=output,
            _request_auth=_request_auth,
    ...
    @validate_call
    def merge_templates_with_http_info(
        self,
        batch_data_inner: Annotated[List[BatchDataInner], Field(description="Data used to specify templates and data objects which are used to merge the template")],
        name: Annotated[Optional[StrictStr], Field(description="Document name, returned in the meta data.")] = None,
        format: Annotated[Optional[StrictStr], Field(description="Document format. The zip option will return a ZIP file with PDF files.")] = None,
    ...
    @validate_call
    def merge_templates_without_preload_content(
        self,
        batch_data_inner: Annotated[List[BatchDataInner], Field(description="Data used to specify templates and data objects which are used to merge the template")],
        name: Annotated[Optional[StrictStr], Field(description="Document name, returned in the meta data.")] = None,
        format: Annotated[Optional[StrictStr], Field(description="Document format. The zip option will return a ZIP file with PDF files.")] = None,
    ...
    def _merge_templates_serialize(
        self,
        batch_data_inner,
        name,
        format,
        ...
        # process the form parameters
        # process the body parameter
        if batch_data_inner is not None:
            _body_params = batch_data_inner
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/templates/output',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
