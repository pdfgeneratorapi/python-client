...
class TemplateVersionsApi:
    ...
    def delete_template_version(
        ...
        template_version: Annotated[StrictInt, Field(description="Unique ID of the template version.")],
        ...
        :param template_version: Unique ID of the template version. (required)
    ...
    def _delete_template_version_serialize(
        ...
        if template_version is not None:
            _path_params['templateVersion'] = template_version
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/templates/{templateId}/versions/{templateVersion}',
    ...
    def get_template_version(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '403': "InlineObject23",
            '404': "InlineObject24",
            '422': "GetTemplateVersion422Response",
            '429': "InlineObject26",
            '500': "InlineObject27",
        }
        response_data = self.api_client.call_api(
    ...
    def list_template_versions_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TemplateVersionCollection]:
        """List template versions
    ...
    def _list_template_versions_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/templates/{templateId}/versions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def promote_template_version(
        ...
        _param = self._promote_template_version_serialize(
            template_id=template_id,
            template_version=template_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PromoteTemplateVersion200Response",
            '401': "InlineObject21",
            '403': "InlineObject23",
            '404': "InlineObject24",
            '422': "InlineObject25",
    ...
    @validate_call
    def promote_template_version_with_http_info(
        self,
        template_id: Annotated[StrictInt, Field(description="Template unique identifier")],
        template_version: Annotated[StrictInt, Field(description="Unique ID of the template version.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PromoteTemplateVersion200Response]:
        """Promote template version
    ...
    @validate_call
    def promote_template_version_without_preload_content(
        self,
        template_id: Annotated[StrictInt, Field(description="Template unique identifier")],
        template_version: Annotated[StrictInt, Field(description="Unique ID of the template version.")],
        _request_timeout: Union[
    ...
    def _promote_template_version_serialize(
        self,
        template_id,
        template_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/templates/{templateId}/versions/{templateVersion}/promote',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
