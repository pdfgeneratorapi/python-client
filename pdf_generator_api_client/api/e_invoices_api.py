...
class EInvoicesApi:
    ...
    def create_e_invoice(
        self,
        create_e_invoice_request: Annotated[CreateEInvoiceRequest, Field(description="eInvoice conversion")],
        ...
        :param create_e_invoice_request: eInvoice conversion (required)
        :type create_e_invoice_request: CreateEInvoiceRequest
        ...
        _param = self._create_e_invoice_serialize(
            create_e_invoice_request=create_e_invoice_request,
    ...
    @validate_call
    def create_e_invoice_with_http_info(
        self,
        create_e_invoice_request: Annotated[CreateEInvoiceRequest, Field(description="eInvoice conversion")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_e_invoice_without_preload_content(
        self,
        create_e_invoice_request: Annotated[CreateEInvoiceRequest, Field(description="eInvoice conversion")],
        _request_timeout: Union[
            None,
    ...
    def _create_e_invoice_serialize(
        self,
        create_e_invoice_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if create_e_invoice_request is not None:
            _body_params = create_e_invoice_request
    ...
    @validate_call
    def create_factur_xe_invoice(
        self,
        create_factur_xe_invoice_request: Annotated[CreateFacturXEInvoiceRequest, Field(description="eInvoice conversion")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param create_factur_xe_invoice_request: eInvoice conversion (required)
        :type create_factur_xe_invoice_request: CreateFacturXEInvoiceRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_factur_xe_invoice_serialize(
            create_factur_xe_invoice_request=create_factur_xe_invoice_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def create_factur_xe_invoice_with_http_info(
        self,
        create_factur_xe_invoice_request: Annotated[CreateFacturXEInvoiceRequest, Field(description="eInvoice conversion")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_factur_xe_invoice_without_preload_content(
        self,
        create_factur_xe_invoice_request: Annotated[CreateFacturXEInvoiceRequest, Field(description="eInvoice conversion")],
        _request_timeout: Union[
            None,
    ...
    def _create_factur_xe_invoice_serialize(
        self,
        create_factur_xe_invoice_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if create_factur_xe_invoice_request is not None:
            _body_params = create_factur_xe_invoice_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/einvoice/facturx',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def create_x_rechnung_e_invoice(
        self,
        create_e_invoice_request: Annotated[CreateEInvoiceRequest, Field(description="eInvoice conversion")],
        _request_timeout: Union[
            None,
        ...
        _param = self._create_x_rechnung_e_invoice_serialize(
            create_e_invoice_request=create_e_invoice_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def create_x_rechnung_e_invoice_with_http_info(
        self,
        create_e_invoice_request: Annotated[CreateEInvoiceRequest, Field(description="eInvoice conversion")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_x_rechnung_e_invoice_without_preload_content(
        self,
        create_e_invoice_request: Annotated[CreateEInvoiceRequest, Field(description="eInvoice conversion")],
        _request_timeout: Union[
            None,
    ...
    def _create_x_rechnung_e_invoice_serialize(
        self,
        create_e_invoice_request,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/einvoice/xrechnung',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_e_invoice_schema(
        ...
        _param = self._get_e_invoice_schema_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_e_invoice_schema_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_e_invoice_schema_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_e_invoice_schema_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
