...
class AssetsApi:
    ...
    def generate_qr_code(
        self,
        generate_qr_code_request: Annotated[GenerateQRCodeRequest, Field(description="QR Code configuration")],
        ...
        :param generate_qr_code_request: QR Code configuration (required)
        :type generate_qr_code_request: GenerateQRCodeRequest
    ...
    def generate_qr_code_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GenerateQRCode201Response]:
        """Generate QR Code
    ...
    def _generate_qr_code_serialize(
        ...
        if generate_qr_code_request is not None:
            _body_params = generate_qr_code_request
