...
class FormsApi:
    ...
    def create_from(
        ...
        _param = self._create_from_serialize(
    ...
    @validate_call
    def create_from_with_http_info(
        self,
        form_configuration_new: Annotated[FormConfigurationNew, Field(description="Form configuration")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateFrom201Response]:
        """Create form
    ...
    @validate_call
    def create_from_without_preload_content(
        self,
        form_configuration_new: Annotated[FormConfigurationNew, Field(description="Form configuration")],
        _request_timeout: Union[
            None,
    ...
    def share_form_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ShareForm201Response]:
        """Share form
