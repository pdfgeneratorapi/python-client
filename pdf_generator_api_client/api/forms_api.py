...
class FormsApi:
    ...
    def create_form(
        self,
        form_configuration_new: Annotated[FormConfigurationNew, Field(description="Form configuration")],
        ...
        :param form_configuration_new: Form configuration (required)
        :type form_configuration_new: FormConfigurationNew
        ...
        _param = self._create_form_serialize(
            form_configuration_new=form_configuration_new,
    ...
    def _create_form_serialize(
        ...
        if form_configuration_new is not None:
            _body_params = form_configuration_new
    ...
    def delete_form(
        self,
        form_id: Annotated[StrictInt, Field(description="Form unique identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param form_id: Form unique identifier (required)
        :type form_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def import_form(
        self,
        import_form_request: Annotated[ImportFormRequest, Field(description="Import editable PDF via URL or base64 string as form")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param import_form_request: Import editable PDF via URL or base64 string as form (required)
        :type import_form_request: ImportFormRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._import_form_serialize(
            import_form_request=import_form_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def import_form_with_http_info(
        self,
        import_form_request: Annotated[ImportFormRequest, Field(description="Import editable PDF via URL or base64 string as form")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def import_form_without_preload_content(
        self,
        import_form_request: Annotated[ImportFormRequest, Field(description="Import editable PDF via URL or base64 string as form")],
        _request_timeout: Union[
            None,
    ...
    def _import_form_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if import_form_request is not None:
            _body_params = import_form_request
    ...
    def open_form_builder(
        ...
        _param = self._open_form_builder_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def open_form_builder_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def open_form_builder_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _open_form_builder_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def open_form_builder_for_existing_form(
        self,
        form_id: Annotated[StrictInt, Field(description="Form unique identifier")],
        _request_timeout: Union[
            None,
        ...
        _param = self._open_form_builder_for_existing_form_serialize(
            form_id=form_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def open_form_builder_for_existing_form_with_http_info(
        self,
        form_id: Annotated[StrictInt, Field(description="Form unique identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def open_form_builder_for_existing_form_without_preload_content(
        self,
        form_id: Annotated[StrictInt, Field(description="Form unique identifier")],
        _request_timeout: Union[
            None,
    ...
    def _open_form_builder_for_existing_form_serialize(
        self,
        form_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/forms/{formId}/open',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def share_form(
        ...
        _param = self._share_form_serialize(
            form_id=form_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def share_form_without_preload_content(
        self,
        form_id: Annotated[StrictInt, Field(description="Form unique identifier")],
        _request_timeout: Union[
            None,
    ...
    def _share_form_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/forms/{formId}/share',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
