...
class ConversionApi:
    ...
    def convert_html2_pdf(
        ...
        :param convert_html2_pdf_request: (required)
        :type convert_html2_pdf_request: ConvertHTML2PDFRequest
        ...
        _param = self._convert_html2_pdf_serialize(
            convert_html2_pdf_request=convert_html2_pdf_request,
    ...
    @validate_call
    def convert_html2_pdf_with_http_info(
        self,
        convert_html2_pdf_request: ConvertHTML2PDFRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def convert_html2_pdf_without_preload_content(
        self,
        convert_html2_pdf_request: ConvertHTML2PDFRequest,
        _request_timeout: Union[
            None,
    ...
    def _convert_html2_pdf_serialize(
        self,
        convert_html2_pdf_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if convert_html2_pdf_request is not None:
            _body_params = convert_html2_pdf_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/conversion/html2pdf',
    ...
    @validate_call
    def convert_pdf2_image(
        self,
        convert_pdf2_image_request: ConvertPDF2ImageRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param convert_pdf2_image_request: (required)
        :type convert_pdf2_image_request: ConvertPDF2ImageRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._convert_pdf2_image_serialize(
            convert_pdf2_image_request=convert_pdf2_image_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def convert_pdf2_image_with_http_info(
        self,
        convert_pdf2_image_request: ConvertPDF2ImageRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def convert_pdf2_image_without_preload_content(
        self,
        convert_pdf2_image_request: ConvertPDF2ImageRequest,
        _request_timeout: Union[
            None,
    ...
    def _convert_pdf2_image_serialize(
        self,
        convert_pdf2_image_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if convert_pdf2_image_request is not None:
            _body_params = convert_pdf2_image_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/conversion/pdf2image',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def convert_url2_pdf(
        ...
        :param convert_url2_pdf_request: (required)
        :type convert_url2_pdf_request: ConvertURL2PDFRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._convert_url2_pdf_serialize(
            convert_url2_pdf_request=convert_url2_pdf_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def convert_url2_pdf_with_http_info(
        self,
        convert_url2_pdf_request: ConvertURL2PDFRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def convert_url2_pdf_without_preload_content(
        self,
        convert_url2_pdf_request: ConvertURL2PDFRequest,
        _request_timeout: Union[
            None,
    ...
    def _convert_url2_pdf_serialize(
        self,
        convert_url2_pdf_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if convert_url2_pdf_request is not None:
            _body_params = convert_url2_pdf_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/conversion/url2pdf',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
