...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "JSONWebTokenAuth": BearerFormatAuthSetting,
    },
    total=False,
)
...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://us1.pdfgeneratorapi.com/api/v4" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("pdf_generator_api_client")
    ...
    def to_debug_report(self) -> str:
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: 4.0.25\n"\
               "SDK Package Version: 8.0.25".\
