...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "paper_size", "orientation", "output", "filename", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "paper_size", "orientation", "output", "filename", ], str]):
...
class ConvertUrl2Pdf(BaseApi):
    ...
    def convert_url2_pdf(
        ...
        return self._convert_url2_pdf_oapg(
            body=body,
