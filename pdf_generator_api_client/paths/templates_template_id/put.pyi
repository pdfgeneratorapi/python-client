...
# body param
SchemaForRequestBodyApplicationJson = TemplateDefinitionNew


request_body_template_definition_new = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_template_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_template_definition_new.serialize(body, content_type)
...
class UpdateTemplate(BaseApi):
    ...
    def update_template(
        ...
        return self._update_template_oapg(
            body=body,
