...
from pdf_generator_api_client.exceptions import ApiTypeError, ApiValueError, ApiException
from pdf_generator_api_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DocumentsApi()
        api_instance.merge_template  # this is an instance of the class Endpoint
        api_instance.merge_template()  # this invokes api_instance.merge_template.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.merge_template.callable or self.callable in this class
