...
from pdf_generator_api_client.api_response import ApiResponse, T as ApiResponseT
import pdf_generator_api_client.models
from pdf_generator_api_client import rest
from pdf_generator_api_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/4.0.25/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(pdf_generator_api_client.models, klass)
