...
class TemplateDefinitionNew(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class layout(
                ...
                @typing.overload
                def __getitem__(self, name: typing_extensions.Literal["rotaion"]) -> MetaOapg.properties.rotaion: ...
                ...
                def __getitem__(self, name: typing.Union[typing_extensions.Literal["format", "width", "height", "unit", "orientation", "rotaion", "margins", "repeatLayout", "emptyLabels", ], str]):
                    # dict_instance[name] accessor
                    return super().__getitem__(name)
                ...
                @typing.overload
                def get_item_oapg(self, name: typing_extensions.Literal["rotaion"]) -> typing.Union[MetaOapg.properties.rotaion, schemas.Unset]: ...
                ...
                def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["format", "width", "height", "unit", "orientation", "rotaion", "margins", "repeatLayout", "emptyLabels", ], str]):
                    return super().get_item_oapg(name)
                ...
                def __new__(
                    ...
                    *args: typing.Union[dict, frozendict.frozendict, ],
                    ...
                    rotaion: typing.Union[MetaOapg.properties.rotaion, decimal.Decimal, int, schemas.Unset] = schemas.unset,
                        ...
                        class MetaOapg:
                            ...
                            class properties:
                                ...
                                class components(
                                    ...
                                    def __new__(
                                        cls,
                                        arg: typing.Union[typing.Tuple['Component'], typing.List['Component']],
                                        _configuration: typing.Optional[schemas.Configuration] = None,
                                    ) -> 'components':
                                        return super().__new__(
                                            cls,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "tags", "isDraft", "layout", "pages", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "tags", "isDraft", "layout", "pages", ], str]):
        return super().get_item_oapg(name)
