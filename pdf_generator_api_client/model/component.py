            ...
            class cls(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        ...
                        "htmlblockComponent": "HTMLBLOCK_COMPONENT",
                        ...
                        "pagenumberComponent": "PAGENUMBER_COMPONENT",
                        "symbolComponent": "SYMBOL_COMPONENT",
                        "checkboxComponent": "CHECKBOX_COMPONENT",
                        "radioComponent": "RADIO_COMPONENT",
                        "signatureComponent": "SIGNATURE_COMPONENT",
                    }
                ...
                @schemas.classproperty
                def HTMLBLOCK_COMPONENT(cls):
                    return cls("htmlblockComponent")
                ...
                @schemas.classproperty
                def PAGENUMBER_COMPONENT(cls):
                    return cls("pagenumberComponent")
                
                @schemas.classproperty
                def SYMBOL_COMPONENT(cls):
                    return cls("symbolComponent")
                ...
                @schemas.classproperty
                def SIGNATURE_COMPONENT(cls):
                    return cls("signatureComponent")
