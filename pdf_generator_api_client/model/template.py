...
class Template(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "owner", "created_at", "updated_at", "tags", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "owner", "created_at", "updated_at", "tags", ], str]):
