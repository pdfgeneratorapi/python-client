...
class PaginationMeta(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            last_page = schemas.NumberSchema
            __annotations__ = {
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["current_page", "per_page", "total", "last_page", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["current_page", "per_page", "total", "last_page", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        last_page: typing.Union[MetaOapg.properties.last_page, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
