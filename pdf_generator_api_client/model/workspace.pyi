...
class Workspace(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            is_master_workspace = schemas.BoolSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["is_master_workspace"]) -> MetaOapg.properties.is_master_workspace: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "identifier", "is_master_workspace", "created_at", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["is_master_workspace"]) -> typing.Union[MetaOapg.properties.is_master_workspace, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "identifier", "is_master_workspace", "created_at", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        is_master_workspace: typing.Union[MetaOapg.properties.is_master_workspace, bool, schemas.Unset] = schemas.unset,
