...
class InlineResponse401(ModelNormal):
    ...
    allowed_values = {
        ('error',): {
            'FAILED:_REQUEST_EXPIRED': "Authentication failed: request expired",
            'FAILED:_SIGNATURE_OR_SECRET_MISSING': "Authentication failed: signature or secret missing",
            'FAILED:_WORKSPACE_MISSING': "Authentication failed: workspace missing",
            'FAILED:_KEY_MISSING': "Authentication failed: key missing",
            'FAILED:_PROPERTY_&#39;ISS&#39;_(ISSUER)_MISSING_IN_JWT': "Authentication failed: property 'iss' (issuer) missing in JWT",
            'FAILED:_PROPERTY_&#39;SUB&#39;_(SUBJECT)_MISSING_IN_JWT': "Authentication failed: property 'sub' (subject) missing in JWT",
            'FAILED:_PROPERTY_&#39;EXP&#39;_(EXPIRATION_TIME)_MISSING_IN_JWT': "Authentication failed: property 'exp' (expiration time) missing in JWT",
            'FAILED:_INVALID_&#39;ISS&#39;_(ISSUER)': "Authentication failed: invalid 'iss' (issuer)",
            'FAILED:_INCORRECT_SIGNATURE': "Authentication failed: incorrect signature",
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            error (str): Error description. [optional]  # noqa: E501
            status (int): HTTP Error code. [optional]  # noqa: E501
        """
