...
class InlineResponse401(ModelNormal):
    ...
    allowed_values = {
        ('error',): {
            ...
            'FAILED:_PROPERTY_ISS_(ISSUER)_MISSING_IN_JWT': "Authentication failed: property iss (issuer) missing in JWT",
            'FAILED:_PROPERTY_SUB_(SUBJECT)_MISSING_IN_JWT': "Authentication failed: property sub (subject) missing in JWT",
            'FAILED:_PROPERTY_EXP_(EXPIRATION_TIME)_MISSING_IN_JWT': "Authentication failed: property exp (expiration time) missing in JWT",
            'FAILED:_INVALID_ISS_(ISSUER)': "Authentication failed: invalid iss (issuer)",
