...
class InlineResponse402(ModelNormal):
    ...
    allowed_values = {
        ('error',): {
            'YOUR_ACCOUNT_IS_SUSPENDED,_PLEASE_UPGRADE_YOUR_ACCOUNT_OR_CONTACT_SUPPORT@PDFGENERATORAPI.COM': "Your account is suspended, please upgrade your account or contact support@pdfgeneratorapi.com",
        },
    }
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            error (str): Error description. [optional] if omitted the server will use the default value of "Your account is suspended, please upgrade your account or contact support@pdfgeneratorapi.com"  # noqa: E501
