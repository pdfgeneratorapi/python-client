...
class Document(
    ...
    class MetaOapg:
        ...
        class properties:
            public_id = schemas.StrSchema
            public_url = schemas.StrSchema
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["public_id", "public_url", "template_id", "created_at", "expires_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["public_id", "public_url", "template_id", "created_at", "expires_at", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        public_id: typing.Union[MetaOapg.properties.public_id, str, schemas.Unset] = schemas.unset,
        public_url: typing.Union[MetaOapg.properties.public_url, str, schemas.Unset] = schemas.unset,
