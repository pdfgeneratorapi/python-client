...
class InlineResponse403(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            error (str): Error description. [optional] if omitted the server will use the default value of "Your account has exceeded the monthly document generation limit."  # noqa: E501
