...
class InlineResponse422(ModelNormal):
    ...
    allowed_values = {
        ('error',): {
            'UNABLE_TO_PARSE_JSON,_PLEASE_CHECK_FORMATTING': "Unable to parse JSON, please check formatting",
            'REQUIRED_PARAMETER_MISSING': "Required parameter missing",
            'REQUIRED_PARAMETER_MISSING:_TEMPLATE_DEFINITION_NOT_DEFINED': "Required parameter missing: template definition not defined",
            'REQUIRED_PARAMETER_MISSING:_TEMPLATE_NOT_DEFINED': "Required parameter missing: template not defined",
        },
    }
