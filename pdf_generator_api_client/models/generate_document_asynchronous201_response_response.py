...
class GenerateDocumentAsynchronous201ResponseResponse(BaseModel):
    """
    GenerateDocumentAsynchronous201ResponseResponse
    """ # noqa: E501
    job_id: Optional[StrictStr] = Field(default=None, description="Unique job id which is also added to the callback request as header PDF-API-Job-Id")
