...
class InlineObject13(BaseModel):
    ...
    InlineObject13
    """ # noqa: E501
    job_id: Optional[StrictStr] = Field(default=None, description="UUID of the async job.")
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['pending', 'ready', 'published', 'error', 'webhook_error']):
            raise ValueError("must be one of enum values ('pending', 'ready', 'published', 'error', 'webhook_error')")
        return value
