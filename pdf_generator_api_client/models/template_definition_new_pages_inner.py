...
class TemplateDefinitionNewPagesInner(BaseModel):
    """
    ...
    margins: Optional[TemplateDefinitionNewPagesInnerMargins] = None
    border: Optional[StrictBool] = False
    components: Optional[List[Dict[str, Any]]] = None
    layout: Optional[Dict[str, Any]] = Field(default=None, description="Defines page specific layout which can differ from the main template layout (e.g page format, margins).")
    conditional_formats: Optional[List[Dict[str, Any]]] = Field(default=None, alias="conditionalFormats")
    background_image: Optional[StrictStr] = Field(default=None, description="Defines background image for the page.", alias="backgroundImage")
    __properties: ClassVar[List[str]] = ["width", "height", "margins", "border", "components", "layout", "conditionalFormats", "backgroundImage"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "margins": TemplateDefinitionNewPagesInnerMargins.from_dict(obj["margins"]) if obj.get("margins") is not None else None,
            "border": obj.get("border") if obj.get("border") is not None else False,
            "components": obj.get("components"),
            "layout": obj.get("layout"),
            "conditionalFormats": obj.get("conditionalFormats"),
