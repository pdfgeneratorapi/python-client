...
class FormActionSendSendDocumentHeadersInner(BaseModel):
    """
    FormActionSendSendDocumentHeadersInner
    """ # noqa: E501
    name: Annotated[str, Field(strict=True, max_length=255)] = Field(description="Header name")
    value: Annotated[str, Field(strict=True, max_length=255)] = Field(description="Header value")
