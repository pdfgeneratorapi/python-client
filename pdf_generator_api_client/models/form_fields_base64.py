...
class FormFieldsBase64(BaseModel):
    """
    FormFieldsBase64
    """ # noqa: E501
    file_base64: StrictStr = Field(description="PDF document in base64 encoded string format")
    key_field: Optional[KeyFieldParam] = KeyFieldParam.NAME
    __properties: ClassVar[List[str]] = ["file_base64", "key_field"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "key_field": obj.get("key_field") if obj.get("key_field") is not None else KeyFieldParam.NAME
        })
        return _obj
