...
class DataBatchInner(BaseModel):
    """
    DataBatchInner
    """ # noqa: E501
    template: Optional[StrictInt] = Field(default=None, description="Template id")
    data: Optional[Dict[str, Any]] = Field(default=None, description="JSON data used to replace data fields in the template")
    __properties: ClassVar[List[str]] = ["template", "data"]
