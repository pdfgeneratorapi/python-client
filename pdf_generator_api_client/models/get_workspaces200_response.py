...
class GetWorkspaces200Response(BaseModel):
    """
    GetWorkspaces200Response
    """ # noqa: E501
    response: Optional[List[Workspace]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [Workspace.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
