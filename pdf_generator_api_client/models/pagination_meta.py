...
class PaginationMeta(BaseModel):
    ...
    """ # noqa: E501
    current_page: Optional[Union[StrictFloat, StrictInt]] = None
    last_page: Optional[Union[StrictFloat, StrictInt]] = None
    per_page: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["current_page", "last_page", "per_page"]
