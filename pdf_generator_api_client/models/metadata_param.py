...
class MetadataParam(BaseModel):
    ...
    """ # noqa: E501
    author: Optional[StrictStr] = Field(default='Organization name', description="Document author")
    language: Optional[StrictStr] = Field(default='en', description="Document language")
    __properties: ClassVar[List[str]] = ["author", "language"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "author": obj.get("author") if obj.get("author") is not None else 'Organization name',
