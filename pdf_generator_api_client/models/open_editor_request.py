...
class OpenEditorRequest(BaseModel):
    ...
    OpenEditorRequest
    """ # noqa: E501
    data: Optional[OpenEditorRequestData] = None
    language: Optional[StrictStr] = Field(default=None, description="Specify the editor UI language. Defaults to organization editor language.")
    __properties: ClassVar[List[str]] = ["data", "language"]
    ...
    def language_validate_enum(cls, value):
        ...
        if value not in set(['en', 'et', 'cs', 'sk', 'ru', 'de']):
            raise ValueError("must be one of enum values ('en', 'et', 'cs', 'sk', 'ru', 'de')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": OpenEditorRequestData.from_dict(obj["data"]) if obj.get("data") is not None else None,
