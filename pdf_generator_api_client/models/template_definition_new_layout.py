...
class TemplateDefinitionNewLayout(BaseModel):
    ...
    unit: Optional[StrictStr] = Field(default=None, description="Measure unit")
    ...
    empty_labels: Optional[StrictInt] = Field(default=None, description="Defines how many pages or labels should be empty", alias="emptyLabels")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "emptyLabels": obj.get("emptyLabels")
        })
        return _obj
