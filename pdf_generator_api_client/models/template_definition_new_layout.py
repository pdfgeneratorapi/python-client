...
class TemplateDefinitionNewLayout(BaseModel):
    """
    Defines template layout (e.g page format, margins).
    """ # noqa: E501
    format: Optional[StrictStr] = Field(default='A4', description="Defines template page size")
    ...
    unit: Optional[StrictStr] = Field(default='cm', description="Measure unit")
    orientation: Optional[StrictStr] = Field(default=None, description="Page orientation")
    rotation: Optional[StrictInt] = Field(default=None, description="Page rotation in degrees")
    margins: Optional[TemplateDefinitionNewLayoutMargins] = None
    repeat_layout: Optional[TemplateDefinitionNewLayoutRepeatLayout] = Field(default=None, alias="repeatLayout")
    empty_labels: Optional[StrictInt] = Field(default=0, description="Specifies how many blank lables to add to sheet label.", alias="emptyLabels")
    __properties: ClassVar[List[str]] = ["format", "width", "height", "unit", "orientation", "rotation", "margins", "repeatLayout", "emptyLabels"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of repeat_layout
        if self.repeat_layout:
            _dict['repeatLayout'] = self.repeat_layout.to_dict()
        # set to None if repeat_layout (nullable) is None
        # and model_fields_set contains the field
        if self.repeat_layout is None and "repeat_layout" in self.model_fields_set:
            _dict['repeatLayout'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unit": obj.get("unit") if obj.get("unit") is not None else 'cm',
            "orientation": obj.get("orientation"),
            "rotation": obj.get("rotation"),
            "margins": TemplateDefinitionNewLayoutMargins.from_dict(obj["margins"]) if obj.get("margins") is not None else None,
            "repeatLayout": TemplateDefinitionNewLayoutRepeatLayout.from_dict(obj["repeatLayout"]) if obj.get("repeatLayout") is not None else None,
            "emptyLabels": obj.get("emptyLabels") if obj.get("emptyLabels") is not None else 0
        })
        return _obj
