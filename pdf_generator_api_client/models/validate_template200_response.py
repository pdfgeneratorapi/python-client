...
class ValidateTemplate200Response(BaseModel):
    """
    ValidateTemplate200Response
    """ # noqa: E501
    response: Optional[ValidateTemplate200ResponseResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": ValidateTemplate200ResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
