...
class Document(BaseModel):
    ...
    Document
    """ # noqa: E501
    public_id: Optional[StrictStr] = Field(default=None, description="Document unique identifier")
    public_url: Optional[StrictStr] = Field(default=None, description="Public URL of the document")
    template_id: Optional[StrictInt] = Field(default=None, description="Template used to generate the document")
    created_at: Optional[StrictStr] = Field(default=None, description="Date time when the document was generated")
    expires_at: Optional[StrictStr] = Field(default=None, description="Date time when the document url will expire. Document is stored for 30 days.")
    __properties: ClassVar[List[str]] = ["public_id", "public_url", "template_id", "created_at", "expires_at"]
