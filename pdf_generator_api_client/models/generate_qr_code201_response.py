...
class GenerateQRCode201Response(BaseModel):
    """
    GenerateQRCode201Response
    """ # noqa: E501
    response: Optional[StrictStr] = Field(default=None, description="Base64 encoded image if the output=base64. Raw image string if output=file is used")
    meta: Optional[GenerateQRCode201ResponseMeta] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GenerateQRCode201ResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
