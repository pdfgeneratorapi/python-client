...
from pdf_generator_api_client.models.status_param import StatusParam
...
class GetStatus200Response(BaseModel):
    ...
    """ # noqa: E501
    api: Optional[StatusParam] = StatusParam.OK
    chart_api: Optional[StatusParam] = Field(default=StatusParam.OK, alias="chart-api")
    conversion_api: Optional[StatusParam] = Field(default=StatusParam.OK, alias="conversion-api")
    generator_api_sync: Optional[StatusParam] = Field(default=StatusParam.OK, alias="generator-api-sync")
    generator_api_async: Optional[StatusParam] = Field(default=StatusParam.OK, alias="generator-api-async")
    e_invoice: Optional[StatusParam] = Field(default=StatusParam.OK, alias="e-invoice")
    __properties: ClassVar[List[str]] = ["api", "chart-api", "conversion-api", "generator-api-sync", "generator-api-async", "e-invoice"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "api": obj.get("api") if obj.get("api") is not None else StatusParam.OK,
            "chart-api": obj.get("chart-api") if obj.get("chart-api") is not None else StatusParam.OK,
            "conversion-api": obj.get("conversion-api") if obj.get("conversion-api") is not None else StatusParam.OK,
            "generator-api-sync": obj.get("generator-api-sync") if obj.get("generator-api-sync") is not None else StatusParam.OK,
            "generator-api-async": obj.get("generator-api-async") if obj.get("generator-api-async") is not None else StatusParam.OK,
            "e-invoice": obj.get("e-invoice") if obj.get("e-invoice") is not None else StatusParam.OK
        })
        return _obj
