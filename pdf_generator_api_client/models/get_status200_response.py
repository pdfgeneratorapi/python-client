...
class GetStatus200Response(BaseModel):
    ...
    """ # noqa: E501
    api: Optional[StrictStr] = 'ok'
    chart_api: Optional[StrictStr] = Field(default='ok', alias="chart-api")
    conversion_api: Optional[StrictStr] = Field(default='ok', alias="conversion-api")
    generator_api_sync: Optional[StrictStr] = Field(default='ok', alias="generator-api-sync")
    generator_api_async: Optional[StrictStr] = Field(default='ok', alias="generator-api-async")
    __properties: ClassVar[List[str]] = ["api", "chart-api", "conversion-api", "generator-api-sync", "generator-api-async"]

    @field_validator('api')
    def api_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    @field_validator('chart_api')
    def chart_api_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    @field_validator('conversion_api')
    def conversion_api_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    @field_validator('generator_api_sync')
    def generator_api_sync_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    @field_validator('generator_api_async')
    def generator_api_async_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "api": obj.get("api") if obj.get("api") is not None else 'ok',
            "chart-api": obj.get("chart-api") if obj.get("chart-api") is not None else 'ok',
            "conversion-api": obj.get("conversion-api") if obj.get("conversion-api") is not None else 'ok',
            "generator-api-sync": obj.get("generator-api-sync") if obj.get("generator-api-sync") is not None else 'ok',
            "generator-api-async": obj.get("generator-api-async") if obj.get("generator-api-async") is not None else 'ok'
        })
        return _obj
