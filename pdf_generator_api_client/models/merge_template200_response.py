...
class MergeTemplate200Response(BaseModel):
    """
    ...
    meta: Optional[MergeTemplate200ResponseMeta] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": MergeTemplate200ResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
