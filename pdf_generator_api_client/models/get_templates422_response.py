...
class GetTemplates422Response(BaseModel):
    """
    ...
    def error_validate_enum(cls, value):
        ...
        if value not in set(['Unable to parse JSON, please check formatting', 'Required parameter missing', 'Required parameter missing: template definition not defined', 'Required parameter missing: template not defined']):
            raise ValueError("must be one of enum values ('Unable to parse JSON, please check formatting', 'Required parameter missing', 'Required parameter missing: template definition not defined', 'Required parameter missing: template not defined')")
        return value
