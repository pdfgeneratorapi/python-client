...
class WatermarkText(BaseModel):
    ...
    WatermarkText
    """ # noqa: E501
    content: StrictStr = Field(description="Watermark text")
    color: Optional[StrictStr] = Field(default='#000000', description="Watermark text color in hexadecimal format")
    size: Optional[Annotated[int, Field(le=80, strict=True, ge=7)]] = Field(default=48, description="Watermark text font size in px")
    opacity: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0.1)], Annotated[int, Field(le=1, strict=True, ge=1)]]] = Field(default=0.5, description="Watermark text opaxity")
    position: Optional[WatermarkPosition] = WatermarkPosition.CENTER
    rotation: Optional[Annotated[int, Field(le=180, strict=True, ge=-180)]] = Field(default=0, description="Watermark rotation")
    __properties: ClassVar[List[str]] = ["content", "color", "size", "opacity", "position", "rotation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size") if obj.get("size") is not None else 48,
            "opacity": obj.get("opacity") if obj.get("opacity") is not None else 0.5,
            "position": obj.get("position") if obj.get("position") is not None else WatermarkPosition.CENTER,
