...
class FormFillBase64(BaseModel):
    """
    FormFillBase64
    """ # noqa: E501
    file_base64: StrictStr = Field(description="PDF document in base64 encoded string format")
    data: Dict[str, Any] = Field(description="Form field data to fill in the PDF")
    ...
    __properties: ClassVar[List[str]] = ["file_base64", "data", "output", "name"]
