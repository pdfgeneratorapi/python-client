...
class ImportFormBase64(BaseModel):
    """
    ImportFormBase64
    """ # noqa: E501
    file_base64: StrictStr = Field(description="PDF file from base64 string to import")
    form: Optional[FormConfigurationNew] = None
    __properties: ClassVar[List[str]] = ["file_base64", "form"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "form": FormConfigurationNew.from_dict(obj["form"]) if obj.get("form") is not None else None
        })
        return _obj
