...
class DocumentUser(BaseModel):
    ...
    id_code: Optional[StrictStr] = Field(default=None, description="National identification code, when provided.")
    ip: Optional[StrictStr] = Field(default=None, description="IP address captured when the action was performed.")
    __properties: ClassVar[List[str]] = ["first_name", "last_name", "email", "id_code", "ip"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if id_code (nullable) is None
        # and model_fields_set contains the field
        if self.id_code is None and "id_code" in self.model_fields_set:
            _dict['id_code'] = None
