...
class GenerateQRCode201ResponseMeta(BaseModel):
    """
    GenerateQRCode201ResponseMeta
    """ # noqa: E501
    encoding: Optional[StrictStr] = Field(default=None, description="Response encoding")
    content_type: Optional[StrictStr] = Field(default=None, description="Response content type.", alias="content-type")
    __properties: ClassVar[List[str]] = ["encoding", "content-type"]
