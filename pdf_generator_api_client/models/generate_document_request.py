...
class GenerateDocumentRequest(BaseModel):
    ...
    output: Optional[OutputParam] = OutputParam.BASE64
    ...
    __properties: ClassVar[List[str]] = ["template", "format", "output", "name", "testing", "make_accessible", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "output": obj.get("output") if obj.get("output") is not None else OutputParam.BASE64,
