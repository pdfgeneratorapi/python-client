...
class WatermarkImageContentUrl(BaseModel):
    """
    WatermarkImageContentUrl
    """ # noqa: E501
    content_url: StrictStr = Field(description="URL to an image")
    ...
    __properties: ClassVar[List[str]] = ["content_url", "position", "rotation", "scale"]
