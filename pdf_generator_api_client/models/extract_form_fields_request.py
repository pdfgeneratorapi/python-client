...
EXTRACTFORMFIELDSREQUEST_ONE_OF_SCHEMAS = ["FormFieldsBase64", "FormFieldsUrl"]

class ExtractFormFieldsRequest(BaseModel):
    """
    ExtractFormFieldsRequest
    """
    # data type: FormFieldsUrl
    oneof_schema_1_validator: Optional[FormFieldsUrl] = None
    # data type: FormFieldsBase64
    oneof_schema_2_validator: Optional[FormFieldsBase64] = None
    actual_instance: Optional[Union[FormFieldsBase64, FormFieldsUrl]] = None
    one_of_schemas: Set[str] = { "FormFieldsBase64", "FormFieldsUrl" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = ExtractFormFieldsRequest.model_construct()
        error_messages = []
        match = 0
        # validate data type: FormFieldsUrl
        if not isinstance(v, FormFieldsUrl):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FormFieldsUrl`")
        else:
            match += 1
        # validate data type: FormFieldsBase64
        if not isinstance(v, FormFieldsBase64):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FormFieldsBase64`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in ExtractFormFieldsRequest with oneOf schemas: FormFieldsBase64, FormFieldsUrl. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in ExtractFormFieldsRequest with oneOf schemas: FormFieldsBase64, FormFieldsUrl. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into FormFieldsUrl
        try:
            instance.actual_instance = FormFieldsUrl.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into FormFieldsBase64
        try:
            instance.actual_instance = FormFieldsBase64.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into ExtractFormFieldsRequest with oneOf schemas: FormFieldsBase64, FormFieldsUrl. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ExtractFormFieldsRequest with oneOf schemas: FormFieldsBase64, FormFieldsUrl. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], FormFieldsBase64, FormFieldsUrl]]:
