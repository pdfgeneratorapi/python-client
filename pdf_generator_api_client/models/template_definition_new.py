...
class TemplateDefinitionNew(BaseModel):
    ...
    tags: Optional[List[StrictStr]] = Field(default=None, description="A list of tags assigned to a template")
    is_draft: Optional[StrictBool] = Field(default=None, description="Indicates if the template is a draft or published.", alias="isDraft")
    layout: Optional[TemplateDefinitionNewLayout] = None
    pages: Optional[List[TemplateDefinitionNewPagesInner]] = Field(default=None, description="Defines page or label size, margins and components on page or label")
    data_settings: Optional[TemplateDefinitionNewDataSettings] = Field(default=None, alias="dataSettings")
    editor: Optional[TemplateDefinitionNewEditor] = None
    font_subsetting: Optional[StrictBool] = Field(default=False, description="If font-subsetting is applied to document when generated", alias="fontSubsetting")
    barcode_as_image: Optional[StrictBool] = Field(default=False, description="Defines if barcodes are rendered as raster images instead of vector graphics.", alias="barcodeAsImage")
    __properties: ClassVar[List[str]] = ["name", "tags", "isDraft", "layout", "pages", "dataSettings", "editor", "fontSubsetting", "barcodeAsImage"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.pages:
            ...
            _dict['pages'] = _items
        # override the default output from pydantic by calling `to_dict()` of data_settings
        if self.data_settings:
            _dict['dataSettings'] = self.data_settings.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "layout": TemplateDefinitionNewLayout.from_dict(obj["layout"]) if obj.get("layout") is not None else None,
            "pages": [TemplateDefinitionNewPagesInner.from_dict(_item) for _item in obj["pages"]] if obj.get("pages") is not None else None,
            "dataSettings": TemplateDefinitionNewDataSettings.from_dict(obj["dataSettings"]) if obj.get("dataSettings") is not None else None,
            "editor": TemplateDefinitionNewEditor.from_dict(obj["editor"]) if obj.get("editor") is not None else None,
            "fontSubsetting": obj.get("fontSubsetting") if obj.get("fontSubsetting") is not None else False,
            "barcodeAsImage": obj.get("barcodeAsImage") if obj.get("barcodeAsImage") is not None else False
        })
        return _obj
