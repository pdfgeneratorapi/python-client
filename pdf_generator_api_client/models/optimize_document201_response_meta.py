...
class OptimizeDocument201ResponseMeta(BaseModel):
    """
    OptimizeDocument201ResponseMeta
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Document name. This value is automatically generated if name attribute is not defined in request.")
    display_name: Optional[StrictStr] = Field(default=None, description="Document name without the file extension.")
    encoding: Optional[StrictStr] = Field(default=None, description="Document encoding")
    content_type: Optional[StrictStr] = Field(default=None, description="Document content type.", alias="content-type")
    stats: Optional[OptimizeDocument201ResponseMetaStats] = None
    public_id: Optional[StrictStr] = Field(default=None, description="Document public id, if output=url was used for document storage")
    __properties: ClassVar[List[str]] = ["name", "display_name", "encoding", "content-type", "stats", "public_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stats": OptimizeDocument201ResponseMetaStats.from_dict(obj["stats"]) if obj.get("stats") is not None else None,
