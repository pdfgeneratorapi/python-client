...
class ImportTemplateBase64(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["template", "file_base64"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "template": ImportTemplateUrlTemplate.from_dict(obj["template"]) if obj.get("template") is not None else None,
