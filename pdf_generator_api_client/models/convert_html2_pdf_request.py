...
class ConvertHTML2PDFRequest(BaseModel):
    """
    ConvertHTML2PDFRequest
    """ # noqa: E501
    content: Optional[StrictStr] = Field(default=None, description="HTML content")
    paper_size: Optional[StrictStr] = Field(default='a4', description="PDF page size")
    orientation: Optional[StrictStr] = 'portrait'
    output: Optional[StrictStr] = Field(default='base64', description="Output")
    filename: Optional[StrictStr] = Field(default=None, description="Document name")
    __properties: ClassVar[List[str]] = ["content", "paper_size", "orientation", "output", "filename"]
    ...
    def paper_size_validate_enum(cls, value):
        ...
        if value not in set(['a0', 'a1', 'a2', 'a3', 'a4', 'legal', 'tabloid', 'letter']):
            raise ValueError("must be one of enum values ('a0', 'a1', 'a2', 'a3', 'a4', 'legal', 'tabloid', 'letter')")
        return value
