...
class InlineObject10Meta(BaseModel):
    ...
    InlineObject10Meta
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="File name with extension. Auto-generated if not provided in request.")
    display_name: Optional[StrictStr] = Field(default=None, description="File name without extension.")
    encoding: Optional[StrictStr] = Field(default=None, description="Encoding of the response data.")
    content_type: Optional[StrictStr] = Field(default=None, description="Image content type.", alias="content-type")
    __properties: ClassVar[List[str]] = ["name", "display_name", "encoding", "content-type"]
