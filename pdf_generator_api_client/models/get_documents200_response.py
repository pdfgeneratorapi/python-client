...
class GetDocuments200Response(BaseModel):
    """
    GetDocuments200Response
    """ # noqa: E501
    response: Optional[List[Document]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [Document.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
