...
class InlineObject(BaseModel):
    ...
    InlineObject
    """ # noqa: E501
    response: Optional[StrictStr] = Field(default=None, description="Base64 encoded XML document if the output=base64 is used.")
    meta: Optional[InlineObjectMeta] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": InlineObjectMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
