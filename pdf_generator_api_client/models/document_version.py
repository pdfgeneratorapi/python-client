...
class DocumentVersion(BaseModel):
    ...
    DocumentVersion
    """ # noqa: E501
    version_id: Optional[StrictStr] = Field(default=None, description="Version identifier (hash).")
    name: Optional[StrictStr] = Field(default=None, description="Version name.")
    person: Optional[DocumentUser] = None
    created_at: Optional[StrictStr] = Field(default=None, description="Creation timestamp (Y-m-d H:i:s).")
    __properties: ClassVar[List[str]] = ["version_id", "name", "person", "created_at"]
