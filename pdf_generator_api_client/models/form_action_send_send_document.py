...
class FormActionSendSendDocument(BaseModel):
    """
    FormActionSendSendDocument
    """ # noqa: E501
    url: StrictStr = Field(description="HTTPS URL where the generated document will be delivered.")
    headers: Optional[List[FormActionSendSendDocumentHeadersInner]] = Field(default=None, description="Optional HTTP headers to include with the delivery request.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "url": obj.get("url"),
            "headers": [FormActionSendSendDocumentHeadersInner.from_dict(_item) for _item in obj["headers"]] if obj.get("headers") is not None else None
        })
        return _obj
