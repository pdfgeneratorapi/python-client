...
class GenerateQRCodeRequest(BaseModel):
    ...
    """ # noqa: E501
    content: StrictStr = Field(description="The content which is used to generate QR code")
    color: Optional[StrictStr] = Field(default='#000000', description="QR code in hexadecimal format")
    logo_base64: Optional[StrictStr] = Field(default=None, description="A logo as a base64 image string to add on the QR code")
    logo_url: Optional[StrictStr] = Field(default=None, description="A logo URL to an image to add on the QR code")
    output: Optional[StrictStr] = Field(default='base64', description="Response format")
    __properties: ClassVar[List[str]] = ["content", "color", "logo_base64", "logo_url", "output"]
    ...
    def output_validate_enum(cls, value):
        ...
        if value not in set(['file', 'base64']):
            raise ValueError("must be one of enum values ('file', 'base64')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "logo_base64": obj.get("logo_base64"),
