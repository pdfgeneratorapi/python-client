...
class GenerateDocumentAsynchronous201Response(BaseModel):
    """
    GenerateDocumentAsynchronous201Response
    """ # noqa: E501
    response: Optional[GenerateDocumentAsynchronous201ResponseResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": GenerateDocumentAsynchronous201ResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
