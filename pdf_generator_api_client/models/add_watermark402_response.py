...
class AddWatermark402Response(BaseModel):
    """
    ...
    def message_validate_enum(cls, value):
        ...
        if value not in set(['Your account is suspended, please upgrade your account or contact support@pdfgeneratorapi.com']):
            raise ValueError("must be one of enum values ('Your account is suspended, please upgrade your account or contact support@pdfgeneratorapi.com')")
        return value
