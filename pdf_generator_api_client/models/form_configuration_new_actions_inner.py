...
FORMCONFIGURATIONNEWACTIONSINNER_ANY_OF_SCHEMAS = ["FormActionDownload", "FormActionStore"]
...
class FormConfigurationNewActionsInner(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Optional[Union[FormActionDownload, FormActionStore]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "FormActionDownload", "FormActionStore" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in FormConfigurationNewActionsInner with anyOf schemas: FormActionDownload, FormActionStore. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into FormConfigurationNewActionsInner with anyOf schemas: FormActionDownload, FormActionStore. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], FormActionDownload, FormActionStore]]:
