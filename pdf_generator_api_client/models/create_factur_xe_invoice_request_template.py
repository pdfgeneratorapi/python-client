...
class CreateFacturXEInvoiceRequestTemplate(BaseModel):
    """
    Template id, version, version id and data
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Template ID")
    version_id: Optional[StrictInt] = Field(default=None, description="Template version ID")
    data: Optional[Dict[str, Any]] = Field(default=None, description="JSON payload that represents the Peppol BIS Billing 3.0 UBL Invoice (https://docs.peppol.eu/poacc/billing/3.0/) Use the Get schema endpoint to see the detailed payload structure.")
    __properties: ClassVar[List[str]] = ["id", "version_id", "data"]
