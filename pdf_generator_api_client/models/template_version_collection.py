...
class TemplateVersionCollection(BaseModel):
    """
    TemplateVersionCollection
    """ # noqa: E501
    response: Optional[List[TemplateVersion]] = None
    meta: Optional[TemplateVersionCollectionMeta] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [TemplateVersion.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
            "meta": TemplateVersionCollectionMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
