...
class InlineObject14(BaseModel):
    ...
    InlineObject14
    """ # noqa: E501
    response: Optional[Dict[str, InlineObject14ResponseValue]] = Field(default=None, description="Form fields extracted from the PDF document")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": dict(
                (_k, InlineObject14ResponseValue.from_dict(_v))
