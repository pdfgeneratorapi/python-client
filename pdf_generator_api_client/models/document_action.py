...
class DocumentAction(BaseModel):
    ...
    DocumentAction
    """ # noqa: E501
    action: Optional[StrictStr] = Field(default=None, description="The action performed on the document.")
    person: Optional[DocumentUser] = None
    created_at: Optional[StrictStr] = Field(default=None, description="Action timestamp (Y-m-d H:i:s).")
    __properties: ClassVar[List[str]] = ["action", "person", "created_at"]
    ...
    def action_validate_enum(cls, value):
        ...
        if value not in set(['opened', 'reviewed', 'accepted', 'declined', 'commented', 'signed', 'acknowledged']):
            raise ValueError("must be one of enum values ('opened', 'reviewed', 'accepted', 'declined', 'commented', 'signed', 'acknowledged')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "person": DocumentUser.from_dict(obj["person"]) if obj.get("person") is not None else None,
