...
class CreateFacturXEInvoiceRequest(BaseModel):
    """
    CreateFacturXEInvoiceRequest
    """ # noqa: E501
    template: CreateFacturXEInvoiceRequestTemplate
    profile: Optional[StrictStr] = Field(default='basic', description="Factur-X conformance level.")
    ...
    __properties: ClassVar[List[str]] = ["template", "profile", "output", "name", "metadata"]
    ...
    def profile_validate_enum(cls, value):
        ...
        if value not in set(['basic', 'basicwl', 'en16931', 'minimum', 'extended', 'xrechnung']):
            raise ValueError("must be one of enum values ('basic', 'basicwl', 'en16931', 'minimum', 'extended', 'xrechnung')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "template": CreateFacturXEInvoiceRequestTemplate.from_dict(obj["template"]) if obj.get("template") is not None else None,
            "profile": obj.get("profile") if obj.get("profile") is not None else 'basic',
