...
class InlineObject9Meta(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "display_name", "encoding", "content-type", "public_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InlineObject9Meta from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InlineObject9Meta from a dict"""
        if obj is None:
            return None
