...
class TemplateDefinitionNewDataSettings(BaseModel):
    """
    Defines filter and sort option for root data set.
    """ # noqa: E501
    sort_by: Optional[List[Dict[str, Any]]] = Field(default=None, alias="sortBy")
    filter_by: Optional[List[Dict[str, Any]]] = Field(default=None, alias="filterBy")
    transform: Optional[List[Dict[str, Any]]] = None
    __properties: ClassVar[List[str]] = ["sortBy", "filterBy", "transform"]
