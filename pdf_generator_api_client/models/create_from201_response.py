...
class CreateFrom201Response(BaseModel):
    """
    CreateFrom201Response
    """ # noqa: E501
    response: Optional[FormConfiguration] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": FormConfiguration.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
