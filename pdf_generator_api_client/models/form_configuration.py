...
class FormConfiguration(BaseModel):
    ...
    """ # noqa: E501
    title: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Form title displayed above the form")
    intro: Optional[Annotated[str, Field(strict=True, max_length=1275)]] = Field(default=None, description="Introductory text displayed above the form fields. Supports rich text.")
    outro: Optional[Annotated[str, Field(strict=True, max_length=1275)]] = Field(default=None, description="Closing text displayed below the form fields. Supports rich text.")
    __properties: ClassVar[List[str]] = ["title", "intro", "outro"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if outro (nullable) is None
        # and model_fields_set contains the field
        if self.outro is None and "outro" in self.model_fields_set:
            _dict['outro'] = None
