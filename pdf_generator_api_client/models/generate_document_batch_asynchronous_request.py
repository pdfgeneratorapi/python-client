...
class GenerateDocumentBatchAsynchronousRequest(BaseModel):
    """
    GenerateDocumentBatchAsynchronousRequest
    """ # noqa: E501
    template: Optional[List[TemplateParam]] = None
    ...
    __properties: ClassVar[List[str]] = ["template", "callback", "format", "output", "name", "testing", "metadata"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.template:
            for _item_template in self.template:
                if _item_template:
                    _items.append(_item_template.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "template": [TemplateParam.from_dict(_item) for _item in obj["template"]] if obj.get("template") is not None else None,
