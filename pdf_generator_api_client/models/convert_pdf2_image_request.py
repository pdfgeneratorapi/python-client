...
class ConvertPDF2ImageRequest(BaseModel):
    """
    ConvertPDF2ImageRequest
    """ # noqa: E501
    file_base64: Optional[StrictStr] = Field(default=None, description="Base64 encoded PDF file. Required if file_url is not provided.")
    file_url: Optional[StrictStr] = Field(default=None, description="Public HTTPS URL to a PDF file. Required if file_base64 is not provided.")
    format: Optional[StrictStr] = Field(default='png', description="Output image format")
    quality: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = Field(default=85, description="Image quality (1-100)")
    resolution: Optional[Annotated[int, Field(le=600, strict=True, ge=72)]] = Field(default=150, description="Image resolution in DPI (72-600)")
    pages: Optional[StrictStr] = Field(default='all', description="Page number or range to convert. Use a single number (e.g. \"1\") or a range (e.g. \"1-4\"). Defaults to all pages.")
    output: Optional[StrictStr] = Field(default='base64', description="Output format")
    name: Optional[Annotated[str, Field(strict=True, max_length=120)]] = Field(default=None, description="Document name (max 120 characters). Auto-generated if not provided.")
    __properties: ClassVar[List[str]] = ["file_base64", "file_url", "format", "quality", "resolution", "pages", "output", "name"]
    ...
    def format_validate_enum(cls, value):
        ...
        if value not in set(['png', 'jpeg', 'jpg']):
            raise ValueError("must be one of enum values ('png', 'jpeg', 'jpg')")
        return value
    ...
    def output_validate_enum(cls, value):
        ...
        if value not in set(['base64', 'file']):
            raise ValueError("must be one of enum values ('base64', 'file')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "file_base64": obj.get("file_base64"),
            ...
            "resolution": obj.get("resolution") if obj.get("resolution") is not None else 150,
            "pages": obj.get("pages") if obj.get("pages") is not None else 'all',
            "output": obj.get("output") if obj.get("output") is not None else 'base64',
            "name": obj.get("name")
        })
        return _obj
