...
class TemplateDefinition(BaseModel):
    ...
    data_settings: Optional[TemplateDefinitionDataSettings] = Field(default=None, alias="dataSettings")
    editor: Optional[TemplateDefinitionEditor] = None
    __properties: ClassVar[List[str]] = ["id", "name", "tags", "isDraft", "layout", "pages", "dataSettings", "editor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dataSettings": TemplateDefinitionDataSettings.from_dict(obj["dataSettings"]) if obj.get("dataSettings") is not None else None,
            "editor": TemplateDefinitionEditor.from_dict(obj["editor"]) if obj.get("editor") is not None else None
        })
        return _obj
