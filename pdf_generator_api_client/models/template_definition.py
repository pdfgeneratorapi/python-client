...
class TemplateDefinition(BaseModel):
    ...
    pages: Optional[List[TemplateDefinitionPagesInner]] = Field(default=None, description="Defines page or label size, margins and components on page or label")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pages": [TemplateDefinitionPagesInner.from_dict(_item) for _item in obj["pages"]] if obj.get("pages") is not None else None,
