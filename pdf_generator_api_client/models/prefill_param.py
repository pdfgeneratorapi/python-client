...
class PrefillParam(BaseModel):
    """
    Viewer prefill data, encrypted into the viewer URL. Only applied when `output` is `viewer`.
    """ # noqa: E501
    id_code: Optional[Annotated[str, Field(strict=True, max_length=128)]] = None
    ...
    signature_id: Optional[Annotated[str, Field(strict=True, max_length=128)]] = None
    editable: Optional[StrictBool] = True
    __properties: ClassVar[List[str]] = ["id_code", "first_name", "last_name", "email", "signature_id", "editable"]
