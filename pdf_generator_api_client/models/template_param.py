...
class TemplateParam(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": TemplateParamId.from_dict(obj["id"]) if obj.get("id") is not None else None,
            "version_id": obj.get("version_id"),
            "data": TemplateParamData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
