...
class InlineObject1Response(BaseModel):
    """
    InlineObject1Response
    """ # noqa: E501
    valid: Optional[StrictBool] = Field(default=True, description="True if template configuration was valid")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InlineObject1Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InlineObject1Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "valid": obj.get("valid") if obj.get("valid") is not None else True
        })
        return _obj
