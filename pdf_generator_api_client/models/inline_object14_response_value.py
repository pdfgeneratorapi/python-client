...
from pdf_generator_api_client.models.inline_object14_response_value_default import InlineObject14ResponseValueDefault
...
class InlineObject14ResponseValue(BaseModel):
    """
    InlineObject14ResponseValue
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique field identifier")
    ...
    value: Optional[InlineObject14ResponseValueValue] = None
    locked: Optional[StrictBool] = Field(default=None, description="Whether the field is locked")
    pages: Optional[List[StrictInt]] = Field(default=None, description="Pages where the field appears")
    default: Optional[InlineObject14ResponseValueDefault] = None
    defaults: Optional[List[StrictStr]] = Field(default=None, description="Default values for multi-select fields")
    values: Optional[List[StrictStr]] = Field(default=None, description="Selected values for multi-select fields")
    options: Optional[List[StrictStr]] = Field(default=None, description="Available options for select fields")
    format: Optional[StrictStr] = Field(default=None, description="Field format (for date fields)")
    maxlen: Optional[StrictInt] = Field(default=None, description="Maximum field length")
    multiline: Optional[StrictBool] = Field(default=None, description="Whether text field is multiline")
    editable: Optional[StrictBool] = Field(default=None, description="Whether combo box is editable")
    multi: Optional[StrictBool] = Field(default=None, description="Whether list box allows multiple selections")
    __properties: ClassVar[List[str]] = ["id", "type", "name", "value", "locked", "pages", "default", "defaults", "values", "options", "format", "maxlen", "multiline", "editable", "multi"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['textfield', 'datefield', 'checkbox', 'radiobuttongroup', 'combobox', 'listbox']):
            raise ValueError("must be one of enum values ('textfield', 'datefield', 'checkbox', 'radiobuttongroup', 'combobox', 'listbox')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "name": obj.get("name"),
            "value": InlineObject14ResponseValueValue.from_dict(obj["value"]) if obj.get("value") is not None else None,
            "locked": obj.get("locked"),
            "pages": obj.get("pages"),
            "default": InlineObject14ResponseValueDefault.from_dict(obj["default"]) if obj.get("default") is not None else None,
