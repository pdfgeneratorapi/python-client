...
class GetDocument200Response(BaseModel):
    """
    GetDocument200Response
    """ # noqa: E501
    response: Optional[StrictStr] = Field(default=None, description="Public URL to the document.")
    meta: Optional[GetDocument200ResponseMeta] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GetDocument200ResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
