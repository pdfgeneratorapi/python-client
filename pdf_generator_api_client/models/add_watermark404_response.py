...
class AddWatermark404Response(BaseModel):
    """
    ...
    def message_validate_enum(cls, value):
        ...
        if value not in set(['Entity not found', 'Template not found', 'Resource not found', 'None of the templates is available for the workspace.']):
            raise ValueError("must be one of enum values ('Entity not found', 'Template not found', 'Resource not found', 'None of the templates is available for the workspace.')")
        return value
