...
class WatermarkBase64(BaseModel):
    """
    WatermarkBase64
    """ # noqa: E501
    file_base64: StrictStr = Field(description="PDF file from base64 string to add the watermark to")
    watermark: WatermarkFileUrlWatermark
    output: Optional[StrictStr] = Field(default='base64', description="Returned document output")
    name: Optional[StrictStr] = Field(default=None, description="File name of the returned document")
    __properties: ClassVar[List[str]] = ["file_base64", "watermark", "output", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "watermark": WatermarkFileUrlWatermark.from_dict(obj["watermark"]) if obj.get("watermark") is not None else None,
