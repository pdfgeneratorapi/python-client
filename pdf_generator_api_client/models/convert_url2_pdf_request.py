...
class ConvertURL2PDFRequest(BaseModel):
    """
    ConvertURL2PDFRequest
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="Public URL")
    ...
    __properties: ClassVar[List[str]] = ["url", "paper_size", "orientation", "output", "filename"]
