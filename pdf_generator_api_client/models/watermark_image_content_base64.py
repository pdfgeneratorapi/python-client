...
class WatermarkImageContentBase64(BaseModel):
    """
    WatermarkImageContentBase64
    """ # noqa: E501
    content_base64: StrictStr = Field(description="Base64 image string")
    ...
    scale: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0.05)], Annotated[int, Field(le=1, strict=True, ge=1)]]] = Field(default=1, description="Watermark image scale")
    __properties: ClassVar[List[str]] = ["content_base64", "position", "rotation", "scale"]
