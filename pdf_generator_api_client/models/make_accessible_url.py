...
class MakeAccessibleUrl(BaseModel):
    """
    MakeAccessibleUrl
    """ # noqa: E501
    file_url: StrictStr = Field(description="Public URL to a PDF document")
    ...
    __properties: ClassVar[List[str]] = ["file_url", "options", "name", "output", "metadata"]
