...
class TemplateDefinitionNewPagesInnerMargins(BaseModel):
    """
    TemplateDefinitionNewPagesInnerMargins
    """ # noqa: E501
    right: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Page or label margin from right")
    bottom: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Page or label margin from bottom")
    __properties: ClassVar[List[str]] = ["right", "bottom"]
