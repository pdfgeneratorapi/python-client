...
class GetTemplates429Response(BaseModel):
    """
    ...
    def error_validate_enum(cls, value):
        ...
        if value not in set(['You can make up to 5 requests per second and 120 requests per minute.']):
            raise ValueError("must be one of enum values ('You can make up to 5 requests per second and 120 requests per minute.')")
        return value
