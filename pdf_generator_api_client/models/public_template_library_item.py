...
class PublicTemplateLibraryItem(BaseModel):
    """
    PublicTemplateLibraryItem
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique public identifier of the template")
    name: Optional[StrictStr] = Field(default=None, description="Template name")
    tags: Optional[List[StrictStr]] = Field(default=None, description="A list of tags assigned to a public template")
    preview_image_url: Optional[StrictStr] = Field(default=None, description="URL to the template preview image")
    sample_data_url: Optional[StrictStr] = Field(default=None, description="URL to the template sample data")
    __properties: ClassVar[List[str]] = ["id", "name", "tags", "preview_image_url", "sample_data_url"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if sample_data_url (nullable) is None
        # and model_fields_set contains the field
        if self.sample_data_url is None and "sample_data_url" in self.model_fields_set:
            _dict['sample_data_url'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sample_data_url": obj.get("sample_data_url")
        })
        return _obj
