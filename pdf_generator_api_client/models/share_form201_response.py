...
class ShareForm201Response(BaseModel):
    """
    ShareForm201Response
    """ # noqa: E501
    response: Optional[StrictStr] = Field(default=None, description="Public URL for form data collection")
    meta: Optional[ShareForm201ResponseMeta] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": ShareForm201ResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
