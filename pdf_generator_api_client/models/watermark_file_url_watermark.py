...
class WatermarkFileUrlWatermark(BaseModel):
    """
    WatermarkFileUrlWatermark
    """ # noqa: E501
    image: Optional[WatermarkImage] = None
    text: Optional[WatermarkText] = None
    __properties: ClassVar[List[str]] = ["image", "text"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "image": WatermarkImage.from_dict(obj["image"]) if obj.get("image") is not None else None,
            "text": WatermarkText.from_dict(obj["text"]) if obj.get("text") is not None else None
        })
        return _obj
