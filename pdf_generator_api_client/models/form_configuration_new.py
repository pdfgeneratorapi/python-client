...
class FormConfigurationNew(BaseModel):
    """
    FormConfigurationNew
    """ # noqa: E501
    template_id: Optional[StrictInt] = Field(default=None, description="Template ID which is connected to the form")
    name: Optional[StrictStr] = Field(default=None, description="Form name")
    actions: Optional[List[FormConfigurationNewActionsInner]] = Field(default=None, description="Array of action configurations")
    fields: Optional[List[FormFieldsInner]] = Field(default=None, description="A list of form field objects")
    configuration: Optional[FormConfiguration] = None
    __properties: ClassVar[List[str]] = ["template_id", "name", "actions", "fields", "configuration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "actions": [FormConfigurationNewActionsInner.from_dict(_item) for _item in obj["actions"]] if obj.get("actions") is not None else None,
            "fields": [FormFieldsInner.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None,
            "configuration": FormConfiguration.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None
        })
        return _obj
