...
class GenerateDocument201Response(BaseModel):
    """
    GenerateDocument201Response
    """ # noqa: E501
    response: Optional[StrictStr] = Field(default=None, description="Base64 encoded document if the output=base64 is used or URL to the document when the output=url is used.")
    meta: Optional[GenerateDocument201ResponseMeta] = None
    __properties: ClassVar[List[str]] = ["response", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": GenerateDocument201ResponseMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
