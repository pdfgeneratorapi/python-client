...
class DeleteTemplate200Response(BaseModel):
    """
    DeleteTemplate200Response
    """ # noqa: E501
    response: Optional[DeleteTemplate200ResponseResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": DeleteTemplate200ResponseResponse.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
