...
class Workspace(BaseModel):
    ...
    Workspace
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Internal workspace id")
    identifier: Optional[StrictStr] = Field(default=None, description="The unique workspace idenfitifer specified by your application")
    is_master_workspace: Optional[StrictBool] = Field(default=None, description="True if a master workspace")
    created_at: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "identifier", "is_master_workspace", "created_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "is_master_workspace": obj.get("is_master_workspace"),
