...
class FormActionSend(BaseModel):
    """
    Sends the generated document via HTTP POST request to the specified URL.
    """ # noqa: E501
    send_document: Optional[FormActionSendSendDocument] = None
    __properties: ClassVar[List[str]] = ["send_document"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of send_document
        if self.send_document:
            _dict['send_document'] = self.send_document.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "send_document": FormActionSendSendDocument.from_dict(obj["send_document"]) if obj.get("send_document") is not None else None
        })
        return _obj
