...
class TemplateDefinitionNewEditor(BaseModel):
    """
    Configuration preferences for the editor
    """ # noqa: E501
    height_multiplier: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="heightMultiplier")
    __properties: ClassVar[List[str]] = ["heightMultiplier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "heightMultiplier": obj.get("heightMultiplier")
        })
        return _obj
