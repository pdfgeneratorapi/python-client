...
class OptimizeDocument201ResponseMetaStats(BaseModel):
    """
    OptimizeDocument201ResponseMetaStats
    """ # noqa: E501
    original_size: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Document original size")
    optimized_size: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Document size after optimization")
    __properties: ClassVar[List[str]] = ["original_size", "optimized_size"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "optimized_size": obj.get("optimized_size")
        })
        return _obj
