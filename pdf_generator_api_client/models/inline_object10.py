...
class InlineObject10(BaseModel):
    ...
    InlineObject10
    """ # noqa: E501
    response: Optional[List[StrictStr]] = Field(default=None, description="Array of base64 encoded images, one per converted page.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta": InlineObject10Meta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
