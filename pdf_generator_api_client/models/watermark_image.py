...
WATERMARKIMAGE_ANY_OF_SCHEMAS = ["WatermarkImageContentBase64", "WatermarkImageContentUrl"]
...
class WatermarkImage(BaseModel):
    ...
    # data type: WatermarkImageContentUrl
    anyof_schema_1_validator: Optional[WatermarkImageContentUrl] = None
    # data type: WatermarkImageContentBase64
    anyof_schema_2_validator: Optional[WatermarkImageContentBase64] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[WatermarkImageContentBase64, WatermarkImageContentUrl]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "WatermarkImageContentBase64", "WatermarkImageContentUrl" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = WatermarkImage.model_construct()
        error_messages = []
        # validate data type: WatermarkImageContentUrl
        if not isinstance(v, WatermarkImageContentUrl):
            error_messages.append(f"Error! Input type `{type(v)}` is not `WatermarkImageContentUrl`")
        else:
            return v

        # validate data type: WatermarkImageContentBase64
        if not isinstance(v, WatermarkImageContentBase64):
            error_messages.append(f"Error! Input type `{type(v)}` is not `WatermarkImageContentBase64`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in WatermarkImage with anyOf schemas: WatermarkImageContentBase64, WatermarkImageContentUrl. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[WatermarkImageContentUrl] = None
        try:
            instance.actual_instance = WatermarkImageContentUrl.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[WatermarkImageContentBase64] = None
        try:
            instance.actual_instance = WatermarkImageContentBase64.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into WatermarkImage with anyOf schemas: WatermarkImageContentBase64, WatermarkImageContentUrl. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], WatermarkImageContentBase64, WatermarkImageContentUrl]]:
