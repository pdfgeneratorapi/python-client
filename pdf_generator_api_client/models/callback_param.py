...
class CallbackParam(BaseModel):
    ...
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="Public callback URL that is used to make a POST request when the document is generated.")
    headers: Optional[Dict[str, Any]] = Field(default=None, description="A key-value pairs of header values sent with the POST request.")
