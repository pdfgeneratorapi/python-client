...
class Component(BaseModel):
    ...
    """ # noqa: E501
    cls: Optional[StrictStr] = Field(default=None, description="Defines component class/type")
    id: Optional[StrictStr] = Field(default=None, description="Component id")
    width: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Width in units")
    height: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Height in units")
    top: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Position from the page top in units")
    left: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Position from the page left in units")
    zindex: Optional[StrictInt] = Field(default=None, description="Defines the rendering order on page. Components with smaller zindex are rendered before")
    value: Optional[StrictStr] = Field(default=None, description="Component value")
    data_index: Optional[StrictStr] = Field(default=None, description="Defines data field for Table and Container components which are used to iterate over list of items", alias="dataIndex")
    __properties: ClassVar[List[str]] = ["cls", "id", "width", "height", "top", "left", "zindex", "value", "dataIndex"]

    @field_validator('cls')
    def cls_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['labelComponent', 'numberComponent', 'textComponent', 'imageComponent', 'dateComponent', 'hlineComponent', 'vlineComponent', 'tableComponent', 'compositeComponent', 'barcodeComponent', 'qrcodeComponent', 'chartComponent', 'rectangleComponent', 'headerComponent', 'footerComponent', 'checkboxComponent', 'radioComponent']):
            raise ValueError("must be one of enum values ('labelComponent', 'numberComponent', 'textComponent', 'imageComponent', 'dateComponent', 'hlineComponent', 'vlineComponent', 'tableComponent', 'compositeComponent', 'barcodeComponent', 'qrcodeComponent', 'chartComponent', 'rectangleComponent', 'headerComponent', 'footerComponent', 'checkboxComponent', 'radioComponent')")
        return value
