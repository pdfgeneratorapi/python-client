...
class Component(object):
    ...
    def __init__(self, cls=None, id=None, width=None, height=None, top=None, left=None, zindex=None, value=None, data_index=None, local_vars_configuration=None):  # noqa: E501
