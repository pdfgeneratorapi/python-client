...
class Template(BaseModel):
    ...
    owner: Optional[StrictBool] = Field(default=None, description="Indicates if the workspace is the owner of the template")
    created_at: Optional[StrictStr] = Field(default=None, description="Timestamp when the template was created")
    updated_at: Optional[StrictStr] = Field(default=None, description="Timestamp when the template was updated")
    tags: Optional[List[StrictStr]] = Field(default=None, description="A list of tags assigned to a template")
    __properties: ClassVar[List[str]] = ["id", "name", "owner", "created_at", "updated_at", "tags"]
