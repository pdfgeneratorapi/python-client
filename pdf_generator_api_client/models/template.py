...
class Template(BaseModel):
    ...
    modified: Optional[StrictStr] = Field(default=None, description="Timestamp when the template was modified")
    tags: Optional[List[StrictStr]] = Field(default=None, description="A list of tags assigned to a template")
    __properties: ClassVar[List[str]] = ["id", "name", "owner", "modified", "tags"]
