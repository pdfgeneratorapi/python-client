...
class PromoteTemplateVersion200Response(BaseModel):
    """
    PromoteTemplateVersion200Response
    """ # noqa: E501
    response: Optional[TemplateVersion] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": TemplateVersion.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
