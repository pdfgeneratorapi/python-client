...
class CreateWorkspaceRequest(BaseModel):
    ...
    """ # noqa: E501
    identifier: Optional[StrictStr] = Field(default=None, description="A unique identifier of the workspace. Make sure that you can generate the same identifier for your user.")
